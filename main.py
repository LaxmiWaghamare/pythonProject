...
def mainroot():
	...
	#-----------------------------------------------------------------
		#nl = Label(b_frame,text='',fg='blue',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Ms.Laxmi Appasha Waghamare ",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : Laxmi081119@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Mr. Adrian Mercurio",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar,totalamt varchar)")
		...
		'''nl = Label(b_frame,text='wwwlaxmi@.com',fg='blue',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()'''
